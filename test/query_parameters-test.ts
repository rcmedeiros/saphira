...
describe('Parameter types for queries', () => {
    it('should serialize boolean', (done: Done) => {
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?a=0`,
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?a=f`,
                [false, null, null, null, null, null, null, null, null, null],
                'accept f',
            ),
        );
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?a=false`,
                [false, null, null, null, null, null, null, null, null, null],
                'accept false',
            ),
        );
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?a=No`,
                [false, null, null, null, null, null, null, null, null, null],
                'accept No',
            ),
        );
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?a=n`,
                [false, null, null, null, null, null, null, null, null, null],
                'accept n',
            ),
        );
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?a=T`,
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?a=true`,
                [true, null, null, null, null, null, null, null, null, null],
                'accept true',
            ),
        );
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?a=Y`,
                [true, null, null, null, null, null, null, null, null, null],
                'accept Y',
            ),
        );
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?a=yes`,
                [true, null, null, null, null, null, null, null, null, null],
                'accept yes',
            ),
        );
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?a=1`,
                [true, null, null, null, null, null, null, null, null, null],
                'accept 1',
            ),
        );
    ...
    it('should serialize DateTime', (done: Done) => {
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?c=1980-06-09T16:00Z`,
    ...
    it('should serialize number', (done: Done) => {
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?d=${Math.PI}`,
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?d=${encodeURIComponent(Number.MAX_VALUE.toString())}`,
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?d=${encodeURIComponent(Number.MIN_VALUE.toString())}`,
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?d=0`,
    ...
    it('should serialize array of numbers', (done: Done) => {
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?e=0,1,2.34,-1`,
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?e=0&e=1&e=2.34&e=-1`,
                [null, null, null, null, [0, 1, 2.34, -1], null, null, null, null, null],
                'OpenAPI default',
            ),
        );
    ...
    it('should serialize objects', (done: Done) => {
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?f[name]=Kaladin&f[age]=20`,
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?f={"name":"Kaladin","age":20,"surgeBinding":{"order":"WindRunner","bond":"Sylphrena", "surges": ["Adhesion", "Gravitation"]}}`,
                [
                    null,
                    null,
                    null,
    ...
    it('should serialize array of objects', (done: Done) => {
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?g=${JSON.stringify(objects)}`,
                expected,
                'JSON stringified',
            ),
        );
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?g=${JSON.stringify(objects[0])},${JSON.stringify(
                    objects[1],
                )},${JSON.stringify(objects[2])}`,
                expected,
                'JSON stringified without []s',
            ),
        );
    ...
    it('should serialize strings', (done: Done) => {
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?h=~%21%40%23%24%25%5E%26%2A%28%29_%2B%7B%7D%3A%22%3C%3E%3F%7C-%3D%5B%5D%5C%3B%27%2C.%2F&i=Sylphrena`,
    ...
    it('should serialize Array of strings', (done: Done) => {
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?j=Sylphrena&j=Pattern&j=Ivory&j=Glys&j=Wyndle&j=Stormfather`,
                [
                    null,
                    null,
                    null,
        ...
        promises.push(
            testSuccessfulGET(
                `${SERVICE_1_QUERY_PARAMETERS}?j=Sylphrena,Pattern,Ivory,Glys,Wyndle,Stormfather`,
                [
                    null,
                    null,
                    null,
