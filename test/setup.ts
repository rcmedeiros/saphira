...
export const SERVICE_1_WITH_PARAMETER_RETURN_REQUEST: string = `${SERVICE_1}/withParameterReturnRequest`;
export const SERVICE_1_WITHOUT_PARAMETER_RETURN_REQUEST: string = `${SERVICE_1}/withoutParameterReturnRequest`;
